...
int lab6part1()
{
    ...
    double xmin=1.0;
    double xmax=1.4;
    double step=0.2;//change this value to 0.05, 0.1, and 0.2.
    ...
    for (int i=0; i<Nsteps; ++i)
    {
        ...
        yVal[i+1]=yVal[i]+step*(yVal[i]/xVal[i]-pow(xVal[i]/yVal[i],2.0));
    }
    ...
    TGraph* numerical1 = new TGraph(Nsteps,xVal,yVal);
    numerical1->SetLineColor(3);
    numerical1->Draw("L");
    return 0;
}
